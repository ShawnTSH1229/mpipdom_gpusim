...
All modifications are comment with 'GPGPULearning:ZSY_MPIPDOM'. You can search my modification using that key word in the source code. Here is an example of my modification:
